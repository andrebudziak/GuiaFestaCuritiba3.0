...
public class WebService : System.Web.Services.WebService
{
    ...
    [WebMethod(Description = "Montar Menu JSon")]
    [ScriptMethod(UseHttpGet = true)]
    public String montamenuJson(string opcao)
    {
        string comando = "";
        ...
        var json = DataTableToJSON(ds.Tables[0]);
    ...
    public DataSet montabannerlateral(string localbanner)
    {
        ...
        if (localbanner == "2")
        {
            ...
            comando = "select b.codigo,b.descricao,b.largura,b.altura,miniatura,c.nome_fantasia from banner b " +
        ...
        else
        {
            ...
            comando = "select b.codigo,b.descricao,b.largura,b.altura,c.nome_fantasia from banner b " +
                      "inner join anuncio a on a.codigo_cliente = b.codigo_cliente " +
                      "inner join cliente c on c.codigo = b.codigo_cliente " +
                      "where b.codigo_local_banner = " + localbanner + " and b.status=1 and a.status=1  ";
    ...
    [WebMethod(Description = "Montar Banner Lateral JSon")]
    [ScriptMethod(UseHttpGet = true)]
    public String montabannerlateralJSon(string localbanner)
    {
        SqlConnection MyConnection = new SqlConnection();
        MyConnection.ConnectionString = connstring;
        if (localbanner == "2")
        {
            ...
            comando = "select b.codigo,b.descricao,b.largura,b.altura,miniatura,c.nome_fantasia,a.site from banner b " +
                      "inner join anuncio a on a.codigo_cliente = b.codigo_cliente " +
                      "inner join cliente c on c.codigo = b.codigo_cliente " +
                      "where b.codigo_local_banner = " + localbanner + " and b.status=1 and a.status=1  " +
                      "ORDER BY NEWID() ";
        ...
        else
        {
            ...
            comando = "select b.codigo,b.descricao,b.largura,b.altura,c.nome_fantasia,a.site from banner b " +
                      "inner join anuncio a on a.codigo_cliente = b.codigo_cliente " +
                      "inner join cliente c on c.codigo = b.codigo_cliente " +
                      "where b.codigo_local_banner = " + localbanner + " and b.status=1 and a.status=1  ";
    ...
    public DataSet montaBannerPermuta(int codigo_local_banner)
    {
        ...
        comando = "Select b.codigo,b.descricao,b.largura,b.altura,b.codigo_cliente,c.nome_fantasia,c.telefone,a.site from banner b " +
                 "left join banner_categoria bc on b.codigo = bc.codigo_banner " +
                 "inner join cliente c on c.codigo = b.codigo_cliente " +
                 "inner join anuncio a on a.codigo_cliente = b.codigo_cliente " +
                 "where b.codigo_local_banner = " + codigo_local_banner.ToString() + " and b.status=1 order by NEWID() ";
    ...
    [WebMethod(Description = "Monta Banner Permuta JSON")]
    [ScriptMethod(UseHttpGet = true)]
    public string montaBannerPermutaJSON(int codigo_local_banner)
    {
        SqlConnection MyConnection = new SqlConnection();
        MyConnection.ConnectionString = connstring;
        ...
        var json = DataTableToJSON(dtBanner);
        return JsonConvert.SerializeObject(json, Formatting.None);
    }


    [WebMethod(Description = "Consulta Anuncio json ")]
    [ScriptMethod(UseHttpGet = true)]
    public string ConsultaAnuncioTelaJson(int codigo_categoria, string nome_fantasia)
    {
        ...
        if (codigo == 0)
        {
            if (nome == "0")
            {
                comando = "SELECT a.codigo,a.codigo_cliente,a.cep, " +
                          ...
                          "a.senha,a.acesso,a.informacoes,c.nome_fantasia " +
                          "FROM anuncio a " +
                          "INNER JOIN cliente c ON a.codigo_cliente = c.codigo " +
    ...
    public DataSet ConsultaAnuncioCliente(int codigo)
    {
        ...
        if (codigo == 0)
        {
            comando = "SELECT a.codigo,a.codigo_cliente,a.cep, " +
                      "a.bairro,a.cidade,a.endereco, " +
                      "a.telefone,a.email,a.site,a.status , " +
                      "a.senha,a.acesso,c.nome_fantasia " +
                      "FROM anuncio a " +
                      "INNER JOIN cliente c ON a.codigo_cliente = c.codigo " +
                      "LEFT JOIN link l on a.codigo = l.codigo_anuncio " +
                      " order by c.nome_fantasia ";
    ...
    public DataSet ConsultaLocalBanner(int codigo, string nome)
    {
        ...
        if (codigo == 0)
        {
            if (nome == "0")
            {
                comando = "SELECT codigo,descricao,prioridade FROM local_banner ";
            }
            else
            {
                comando = "SELECT codigo,descricao,prioridade FROM local_banner "+
    ...
    [WebMethod(Description = "Excluir Categoria Banner")]
    public Boolean ExcluirCategoriaBanner(int codigo)
    {
        #region Excluir Categoria Banner
        SqlConnection MyConnection2 = new SqlConnection();
        MyConnection2.ConnectionString = connstring;
    ...
    public int IncluirAnuncio(int codigo, int codigo_cliente, string cep, string bairro, string cidade, string endereco, string telefone, string email, string site, int status, string senha, string descricao, string informacoes)
    {
        #region Incluir Anuncio
        SqlConnection MyConnection4 = new SqlConnection();
        MyConnection4.ConnectionString = connstring;

        SqlCommand MyCommand4 = new SqlCommand("sp_inclui_anuncio_novo", MyConnection4);
        SqlTransaction transacao2;
        MyConnection4.Open();
        ...
        try
        {
            ...
            MyCommand4.Parameters.Add("@senha", SqlDbType.VarChar).Value = senha;
            MyCommand4.Parameters.Add("@descricao", SqlDbType.VarChar).Value = descricao;
            MyCommand4.Parameters.Add("@informacoes", SqlDbType.VarChar).Value = informacoes;
    ...
    public int IncluirLink(int codigo, int codigo_anuncio, string orkut, string facebook, string twitter, string pinterest)
    {
        #region Incluir Link
        SqlConnection MyConnection4 = new SqlConnection();
        MyConnection4.ConnectionString = connstring;
        ...
        try
        {
            ...
            MyCommand4.Parameters.Add("@pinterest", SqlDbType.VarChar).Value = pinterest;
    ...
    public int IncluirDestaque(int codigo, string destaque, int status, int tipo_destaque, int prioridade)
    {
        ...
        try
        {
            ...
            MyCommand4.Parameters.Add("@prioridade", SqlDbType.Int).Value = prioridade;
        ...
        if (codigo_banner == 0)
        {
            if (nome == "0")
            {
                comando = "Select b.codigo,b.descricao,b.codigo_local_banner,b.largura,b.altura, " +
                          "b.status as codigo_status,s.descricao as status,l.descricao as local,b.codigo_cliente,b.miniatura,c.nome_fantasia " +
                          "from [banner] b " +
                          "inner join status s on s.codigo = b.status " +
                          "inner join local_banner l on l.codigo = b.codigo_local_banner " +
                          "inner join cliente c ON b.codigo_cliente = c.codigo " ;
            }
            else
            {
                comando = "Select b.codigo,b.descricao,b.codigo_local_banner,b.largura,b.altura, " +
    ...
    public DataSet ConsultaCategoriaBanner(int codigo_banner, string nome)
    {
        ...
        if ((codigo_banner == 0))
        {
            if (nome == "0")
            {
                comando = "select b.descricao as banner,c.descricao as categoria,bc.* from banner b " +
                          "inner join banner_categoria bc on b.codigo = bc.codigo_banner " +
                          "left join categoria c on bc.codigo_categoria = c.codigo ";
            }
            else
            {
                comando = "select b.descricao as banner,c.descricao as categoria,bc.* from banner b " +
    ...
    public DataSet ConsultaLink(int codigo, string anuncio)
    {
        ...
        if ((codigo == 0))
        {
            if (anuncio == "0")
            {
                comando = "SELECT l.codigo,l.codigo_anuncio,c.nome_fantasia,l.orkut,l.facebook,l.twitter,l.gmais,l.pinterest " +
                          "FROM link l " +
                          "INNER JOIN cliente c ON c.codigo = l.codigo_anuncio ";
            }
            else
    ...
    public DataSet ConsultaDestaque(int codigo, string texto, int tipo_destaque)
    {
        ...
        if (texto == "0")
        {
            ...
            {
                if (tipo_destaque == 0)
                    comando = "select * from destaque order by prioridade";
                else
                    comando = "select * from destaque where tipo_destaque =" + tipo_destaque.ToString() + " and status=1 order by prioridade";
    ...
    [WebMethod(Description = "Consulta Noticia JSON")]
    [ScriptMethod(UseHttpGet = true)]
    public String ConsultaNoticaJson(int codigo, string texto, int tipo_destaque)
    {
        #region Consulta Destaque
        SqlConnection MyConnection = new SqlConnection();
        MyConnection.ConnectionString = connstring;
        ...
        if (texto == "0")
        {
            ...
            {
                if (tipo_destaque == 0)
                    comando = "SELECT n.codigo,n.codigo_cliente,n.noticia,n.tipo_noticia,n.prioridade,n.status,c.nome_fantasia,a.site,n.imagem_destaque "+
                               "FROM noticia n " +
                               "inner join cliente c on c.codigo = n.codigo_cliente " +
                ...
                else
                {
                    comando = "SELECT n.codigo,n.codigo_cliente,n.noticia,n.tipo_noticia,n.prioridade,n.status,c.nome_fantasia,a.site,n.imagem_destaque " +
                               ...
                               "inner join cliente c on c.codigo = n.codigo_cliente " +
                               "inner join anuncio a on a.codigo_cliente = c.codigo " +
                               "where n.tipo_noticia =" + tipo_destaque.ToString() + " and n.status=1 " +
                               "order by n.prioridade ";
        ...
        // Cria e preenche o DataTable
        DataTable dtBanner = new DataTable("noticia");
    ...
    [WebMethod(Description = "Consulta Anuncio campo busca site ")]
    public DataSet ConsultaAnuncioBusca(string texto)
    {
        #region Consulta Anuncio Busca

        SqlConnection MyConnection4 = new SqlConnection();
        MyConnection4.ConnectionString = connstring;

        SqlCommand MyCommand4 = new SqlCommand("sp_consulta_anuncio_busca", MyConnection4);
        SqlTransaction transacao2;
        MyConnection4.Open();
        ...
        try
        {
            ...
            MyCommand4.CommandType = CommandType.StoredProcedure;
            MyCommand4.Parameters.Add("@texto", SqlDbType.VarChar).Value = texto;
