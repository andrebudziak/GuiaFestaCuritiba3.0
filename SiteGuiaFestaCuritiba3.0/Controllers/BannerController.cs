...
namespace SiteGuiaFestaCuritiba3._0.Controllers
{
    public class BannerController : Controller
    {
        ...
        public ActionResult Incluir_Banner(int? id, string SearchCliente, string nome, Models.Banner a)
        {
            ...
            return PartialView("~/Views/Admin/Banner/Create.cshtml", a);
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Salvar_Banner(Models.Banner a, string command, string SearchCliente, int? idCliente)
        {
            ...
            if (command == "Salvar")
            {
                ...
                return View("~/Views/Admin/Banner/Index.cshtml", res);
        ...
        public ActionResult Editar_Banner(int id)
        {
            int pageSize = 5;
            int totalpages = 0;
            int totalRecords = 0;
            ...
            return View("~/Views/Admin/Banner/Edit.cshtml", a);
        }

        public ActionResult Excluir_Banner(int id)
        {
            Models.Banner a = new Models.Banner();
        ...
        public ActionResult Listar_Banner(string searchString)
        {
